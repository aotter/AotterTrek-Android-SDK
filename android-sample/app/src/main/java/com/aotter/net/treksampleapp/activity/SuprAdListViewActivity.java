...
public class SuprAdListViewActivity extends AppCompatActivity {

    @BindView(R.id.listview)
    ListView mListView;

    private Context mContext;
    private SuprAdListItemAdapter mAdapter;
    private TKAdN tkAdN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_suprad_list_view);
         ...
         **/
        tkAdN = new TKAdN(this, "post_third", "SUPR_AD");
