...
import com.aotter.net.treksampleapp.adapter.VideoListItemAdapter;
...
public class VideoListViewActivity extends AppCompatActivity {
    ...
    private VideoListItemAdapter mAdapter;
    private TKAdN tkAdN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new VideoListItemAdapter(mContext, mPostTitleList, mPostImageList);
         ...
         **/
        tkAdN = new TKAdN(this, "post_third", "NATIVE_VIDEO");
