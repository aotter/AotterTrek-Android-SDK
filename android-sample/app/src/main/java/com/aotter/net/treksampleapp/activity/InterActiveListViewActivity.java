...
import com.aotter.net.treksampleapp.adapter.InterListItemAdapter;
...
/**
 * Created by SmallMouth on 2017/11/9.
 */

public class InterActiveListViewActivity extends AppCompatActivity {

    @BindView(R.id.listview)
    ListView mListView;

    private InterListItemAdapter mAdapter;
    private TKAdN tkAdN;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new InterListItemAdapter(mContext, mPostTitleList, mPostImageList);
         ...
         **/
        tkAdN = new TKAdN(this, "post_third", "NATIVE_INTERACTIVE");
//        tkAdN.setMediaBackgroundBlack(true);
    ...
    protected void onResume() {
        ...
        if (mAdapter.getMediaView() != null) {
            mAdapter.getMediaView().onResume();
        }
    }
