...
public class TrekMediaAdRenderer implements MoPubAdRenderer<TrekNative.TrekMediaEnabledNativeAd> {
     ...
     */
    public TrekMediaAdRenderer(final Activity activity, boolean interActiveShowAction, final ViewBinder viewBinder) {
